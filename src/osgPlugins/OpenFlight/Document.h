...
class Document
{
    ...
    protected:
		...
		std::vector<osg::ref_ptr<osgDB::Archive>> _Archive;
		std::vector<std::string>				  _Archive_FileName;
		std::string				                  _Archive_KeyName;
		std::vector<osgDB::Archive::FileNameList> _Archive_FileList;
